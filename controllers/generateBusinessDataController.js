...
// @access  Public
export const generateBusinessDataHandler = async (req, res) => {
  // const businessData2 = {
  ...
  console.log(`{
    error: "You are at your end of provided free Cloud Vision API credits. Please enter a billing method to keep using the service.
